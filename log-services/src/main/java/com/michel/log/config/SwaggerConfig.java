...
public class SwaggerConfig {
	...
	public Docket detalheApi() {
		...
		.select()
		.apis(RequestHandlerSelectors.basePackage("com.michel.log.resource"))
	...
	private ApiInfoBuilder informacoesApi() {
		...
		apiInfoBuilder.title("LogServices");
		apiInfoBuilder.description("Backend da aplicação LogManager");
		apiInfoBuilder.version("1.0.0");
		// apiInfoBuilder.termsOfServiceUrl("Termo de uso: .");
		apiInfoBuilder.license("Teste Prevent Senior");
